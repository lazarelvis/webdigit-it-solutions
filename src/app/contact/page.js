    ...
    <div className="isolate bg-white px-6 py-16 sm:py-20 lg:px-8">
      ...
      <div className="flex flex-col  mx-auto  max-w-7xl justify-center md:flex-row md:pb-30">
        <div className="element-stanga max-w-xl h-auto md:p-8">
          ...
          <p>
            Fie că vrei o ofertă sau ai doar o întrebare, scrie-ne oricând.
            Promitem să revenim rapid cu un răspuns.
          </p>
          <dl className="pt-4">
            <div className="flex ">
              <dt>
              ...
              <dd className="pl-3">Brasov, Str. Ioan Slavici</dd>
            </div>
            <div className="flex pt-3">
              ...
              <dd className="pl-3">0744221795</dd>
            </div>
            <div className="flex pt-3">
              <dt>
                <svg
              ...
              <dd className="pl-3">contact@webdigit.ro</dd>
            </div>
          </dl>
        </div>
        <form
